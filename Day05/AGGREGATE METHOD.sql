...
select round(avg(maas)) from calisanlar2                           
 --noktadan sonrasını(2730)yani ondalık kısmı kaldırır

SELECT round(AVG(maas),2) from calisanlar2                        
  --noktadan sonrasını(2730.77)yani ondalık kısmı 2 rakam olarak kalır
...
--7- Her markanin ismini, calisan sayisini ve o markaya ait calisanlarin maksimum ve minumum maaşini listeleyen bir Sorgu yaziniz. ******-- tekrar bakılacak!!!..****************
SELECT marka_isim,calisan_sayisi,
...
AS enYuksek_ikinci_maas from calisanlar2 
...
AS en_düşük_ikinci_maas from calisanlar2 
...
AS enYuksek_ucuncu_maas from calisanlar2
